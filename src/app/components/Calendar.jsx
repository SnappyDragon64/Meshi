  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-theme-color-highlight text-theme-text-color-highlight hover:bg-theme-color-highlight hover:text-theme-text-color-highlight focus:bg-theme-color-highlight focus:text-theme-text-color-highlight dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
        day_today: "",
        day_outside:
